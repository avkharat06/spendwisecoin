  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-5 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-1/4 -left-1/4 w-[60%] h-[60%] rounded-full opacity-40 animate-pulse" style={{ background: 'radial-gradient(circle, hsla(163, 100%, 39%, 0.12), transparent 70%)' }} />
        <div className="absolute -bottom-1/4 -right-1/4 w-[50%] h-[50%] rounded-full opacity-30 animate-pulse" style={{ background: 'radial-gradient(circle, hsla(148, 60%, 50%, 0.1), transparent 70%)', animationDelay: '1.5s' }} />
      </div>
